...
import { download } from '../../api/bookmall'
...
export default {
    ...
    methods: {
        ...
        downloadBook(book) {
            ...
            return new Promise((resolve, reject) => {
                download(book, book => {
                    ...
                    const text = this.$t('shelf.progressDownload').replace('$1', `${book.title}.epub(${progress})`)
        ...
        removeBook(book) {
            return new Promise((resolve, reject) => {
                removeLocalStorage(`book/${book.fileName}-info`)
                removeLocalForage(`${book.title}`)
                resolve(book)
            })
        },
        hidePopup() {
