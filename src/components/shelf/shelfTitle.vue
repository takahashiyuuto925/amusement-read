...
export default {
    ...
    computed: {
        ...
        selectedText() {
            ...
            return selectedNum <= 0 ? this.$t('shelf.selectBook') : (selectedNum === 1 ? this.$t('shelf.haveSelectedBook').replace('$1', selectedNum) : this.$t('shelf.haveSelectedBooks').replace('$1', selectedNum))
        },
        showBack() {
